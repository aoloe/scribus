...
PropertiesPalette_Content::PropertiesPalette_Content( QWidget* parent) : QStackedWidget(parent)
{
	m_ScMW=0;
	m_doc=0;
	m_item=0;
...
void PropertiesPalette_Content::unsetDoc()
{
	if (m_doc)
	{
		disconnect(m_doc->m_Selection, SIGNAL(selectionChanged()), this, SLOT(handleSelectionChanged()));
...
void PropertiesPalette_Content::unsetItem()
{
	m_haveItem = false;
	m_item     = NULL;
...
PageItem* PropertiesPalette_Content::currentItemFromSelection()
{
